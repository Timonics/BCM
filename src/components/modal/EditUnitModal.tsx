        ...
        <div className="w-full max-w-2xl max-h-[90vh] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-between p-6 border-b border-[#EDF1F7]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[#222B45]">Edit Unit</h2>
                  ...
                  <CardContent className="p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-xs text-blue-900">
                        <p className="font-medium mb-1">Leadership Roles Management</p>
                        <p className="text-blue-800">
                          Update the default leadership positions for this unit. Changes here do not affect currently assigned members. 
                          You can manage active leadership assignments from the Unit Leadership page.
                        </p>
                      </div>
                    </div>
                  </CardContent>
          ...
          <div className="w-full max-w-md bg-white rounded-xl shadow-2xl">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#222B45]">Archive Unit?</h3>
              ...
              <div className="space-y-3 mb-6">
                ...
                {unitData && unitData.activeMembers && unitData.activeMembers > 0 ? (
                  <Card className="border-orange-200 bg-orange-50">
                    <CardContent className="p-3">
                      <div className="flex items-start gap-2">
                        <AlertTriangle className="w-4 h-4 text-orange-600 flex-shrink-0 mt-0.5" />
                        <div className="text-xs text-orange-900">
                          <p className="font-medium mb-1">Active Members Notice</p>
                          <p className="text-orange-800">
                            This unit currently has <span className="font-semibold">{unitData.activeMembers} active member{unitData.activeMembers > 1 ? 's' : ''}</span>. 
                            They will retain their unit assignment history, but the unit will no longer appear in assignment dropdowns for new assignments.
                          </p>
                        </div>
                      </div>
                    </CardContent>
