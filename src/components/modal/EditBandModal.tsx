...
export default function EditBandModal({
  ...
  const hasAgeBracketChanges = () => {
    ...
    if (formData.hasAgeBracket) {
      if (formData.minAge !== originalData.minAge || formData.maxAge !== originalData.maxAge) {
        return true;
      }
    }
        ...
        <div className="w-full max-w-2xl max-h-[90vh] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-between p-6 border-b border-[#EDF1F7]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[#222B45]">Edit Band</h2>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-[#222B45] mb-2">
                      Band Code or Short Name <span className="text-[#8F9BB3] text-xs">(Optional)</span>
                    </label>
                    <input
                      type="text"
                      value={formData.code}
              ...
              <div>
                ...
                {hasBandTypeChange() && bandData && bandData.membersCount && bandData.membersCount > 0 && (
                  <Card className="border-orange-200 bg-orange-50 mb-4">
                    <CardContent className="p-3">
                      <div className="flex items-start gap-2">
                        <AlertTriangle className="w-4 h-4 text-orange-600 flex-shrink-0 mt-0.5" />
                        <div className="text-xs text-orange-900">
                          <p className="font-medium mb-1">Band Type Change Warning</p>
                          <p className="text-orange-800">
                            Changing the band type may affect eligibility for {bandData.membersCount} existing member{bandData.membersCount > 1 ? 's' : ''}. 
                            Members who don't match the new gender requirement will be flagged for review.
                          </p>
                        </div>
                      </div>
                    </CardContent>
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all hover:border-[#009AF4]/50">
                    ...
                    <div className="ml-3 flex-1">
                      <span className="font-medium text-[#222B45]">Male Band</span>
                  ...
                  <label className="flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all hover:border-[#009AF4]/50">
                    ...
                    />
                    <div className="ml-3 flex-1">
                      <span className="font-medium text-[#222B45]">Female Band</span>
                      <p className="text-xs text-[#8F9BB3] mt-0.5">
                  ...
                  <label className="flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all hover:border-[#009AF4]/50">
                    ...
                    />
                    <div className="ml-3 flex-1">
                      <span className="font-medium text-[#222B45]">Mixed Band</span>
                      <p className="text-xs text-[#8F9BB3] mt-0.5">
                        Open to all genders
                      </p>
                    </div>
              ...
              <div>
                ...
                {hasAgeBracketChanges() && bandData && bandData.membersCount && bandData.membersCount > 0 && (
                  <Card className="border-orange-200 bg-orange-50 mb-4">
                    <CardContent className="p-3">
                      <div className="flex items-start gap-2">
                        <AlertTriangle className="w-4 h-4 text-orange-600 flex-shrink-0 mt-0.5" />
                        <div className="text-xs text-orange-900">
                          <p className="font-medium mb-1">Age Bracket Change Warning</p>
                          <p className="text-orange-800">
                            Changing the age restrictions may affect {bandData.membersCount} existing member{bandData.membersCount > 1 ? 's' : ''}. 
                            Members who fall outside the new age range will be marked as "overgrown" but will remain in the band.
                          </p>
                        </div>
                      </div>
                    </CardContent>
                ...
                <div className="flex items-center justify-between p-4 bg-[#F7F9FC] border border-[#EDF1F7] rounded-lg mb-4">
                  <div className="flex-1">
                    <p className="font-medium text-[#222B45] text-sm">Enable Age Restrictions</p>
                    <p className="text-xs text-[#8F9BB3] mt-0.5">
                  ...
                  <button
                    type="button"
                    onClick={() => handleInputChange('hasAgeBracket', !formData.hasAgeBracket)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className={`block text-sm font-medium mb-2 ${
                      formData.hasAgeBracket ? 'text-[#222B45]' : 'text-[#8F9BB3]'
                    }`}>
                      Minimum Age
                    </label>
                    <input
                    ...
                    />
                    {formData.hasAgeBracket && touched.minAge && errors.minAge && (
                      <div className="flex items-center gap-1 mt-1 text-xs text-red-600">
                        <AlertCircle className="w-3 h-3" />
                  ...
                  <div>
                    ...
                    />
                    {formData.hasAgeBracket && touched.maxAge && errors.maxAge && (
                      <div className="flex items-center gap-1 mt-1 text-xs text-red-600">
                        <AlertCircle className="w-3 h-3" />
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-xs text-blue-900">
                        ...
                        <ul className="list-disc list-inside space-y-0.5 text-blue-800">
                          <li>Editing age ranges does not remove existing members</li>
                          <li>Members outside the new age range will be flagged as "overgrown"</li>
                          <li>Use 0-100 for no age restrictions, or disable age bracket</li>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#222B45] mb-2">
                      Band Description <span className="text-[#8F9BB3] text-xs">(Optional)</span>
                    </label>
                    <textarea
                  ...
                  <div className="flex items-center justify-between p-4 bg-[#F7F9FC] border border-[#EDF1F7] rounded-lg">
                    <div className="flex-1">
                      <p className="font-medium text-[#222B45] text-sm">Band Status</p>
                      <p className="text-xs text-[#8F9BB3] mt-0.5">
                        {formData.isActive ? 'Band is active and accepting members' : 'Band is inactive and not accepting members'}
                      </p>
                    </div>
                    <div className="flex items-center gap-3">
          ...
          <div className="w-full max-w-md bg-white rounded-xl shadow-2xl">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#222B45]">Archive Band?</h3>
                  <p className="text-sm text-[#8F9BB3] mt-0.5">This action can be undone later</p>
                </div>
              </div>

              <div className="space-y-3 mb-6">
                <p className="text-sm text-[#222B45]">
                  Archiving <span className="font-semibold">{formData.name}</span> will:
                </p>
