...
import AssignCommitteeMemberModal from '@/components/modal/AssignComitteeMemberModal';
import {
  ArrowLeft,
  Briefcase,
  Calendar,
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-start gap-4 mb-4">
                <div className="w-14 h-14 rounded-xl bg-[#009AF4]/10 flex items-center justify-center shrink-0">
                    ...
                    <>
                      ...
                      <div className="mb-4">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-12 h-12 rounded-full bg-[#009AF4]/10 flex items-center justify-center shrink-0">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-1.5 text-xs text-[#8F9BB3] mt-0.5">
                            ...
                            <span className="truncate max-w-37.5">{member.email}</span>
                          </div>
                        </div>
                      </div>
                    </td>
            ...
            {projectHistory.map((item, index) => (
              <div key={item.id} className="flex gap-4">
                ...
                <div className="flex flex-col items-center">
                  <div className="w-8 h-8 rounded-full bg-[#F7F9FC] border-2 border-[#EDF1F7] flex items-center justify-center shrink-0">
