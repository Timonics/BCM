...
import CreateEditLeadershipRoleModal from "@/components/modal/CreateEditLeadershipRoleModal";
import AssignLeadershipRoleModal from "@/components/modal/AssignLeadershipRoleModal";
import {
  Crown,
  Users,
  AlertTriangle,
...
export default function LeadershipConsolidationDashboard() {
  ...
  const tabs = [
    ...
    { id: "Unit", label: "Unit Leadership", icon: Grid3x3 },
                            ...
                            <>
                              ...
                              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-[#EDF1F7] py-1 z-20">
                                ...
                                {position.status === "Vacant" && (
                                  <button className="w-full px-4 py-2 text-left text-sm text-[#009AF4] hover:bg-[#F7F9FC] flex items-center gap-2">
