...
export class CaptainInfoDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'michael.johnson@church.org',
  })
  email?: string;

  @ApiPropertyOptional({
    description: 'Captain phone',
...
export class BandDetailResponseDto {
  ...
  @ApiPropertyOptional({
    description: 'Band coordinator information',
    type: CoordinatorInfoDto,
  })
  coordinator?: CoordinatorInfoDto;

  @ApiPropertyOptional({
    description: 'Band captain information',
    type: CaptainInfoDto,
  })
  captain?: CaptainInfoDto;

  @ApiPropertyOptional({
    description: 'Date when the band was founded',
    example: '2010-01-15',
  })
  foundedDate?: Date;
  ...
  @ApiProperty({
    description: 'Total number of active members in the band',
    example: 68,
  })
  totalMembers: number;
