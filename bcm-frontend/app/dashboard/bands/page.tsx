...
import AddNewBandModal from "@/components/modal/add-band";
...
export default function BandManagementScreen() {
  ...
  const averageOccupancy = Math.round(
    bands.reduce(
      (sum, band) => sum + (band.membersCount / band.capacity) * 100,
      0,
    ) / bands.length,
  );
  ...
  const filteredBands = bands.filter((band) => {
    ...
    const matchesGender =
      filters.genderType === "all" || band.genderType === filters.genderType;
    const matchesAlerts =
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#8F9BB3] mt-1">
            Manage all church bands and their members
          </p>
        </div>
        <Button
            ...
            <div className="mt-4 pt-4 border-t border-[#EDF1F7] grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters({ ...filters, genderType: e.target.value })
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters({ ...filters, alertStatus: e.target.value })
                  }
                  className="w-full px-4 py-2 border border-[#EDF1F7] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#009AF4] focus:border-transparent text-sm"
                >
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <Badge
                    variant="outline"
                    className={getGenderBadgeColor(band.genderType)}
                  >
                    {band.genderType}
                  </Badge>
                  <Badge
                    variant="outline"
                    className="bg-[#F7F9FC] text-[#222B45] border-[#EDF1F7]"
                  >
                ...
                <div className="flex items-center gap-1 text-xs text-[#8F9BB3] pt-2 border-t border-[#EDF1F7]">
                  ...
                  <span>
                    Updated{" "}
                    {new Date(band.lastUpdated).toLocaleDateString("en-US", {
                      month: "short",
                      day: "numeric",
                    })}
                  </span>
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-[#8F9BB3]">
                            (
                            {Math.round(
                              (band.membersCount / band.capacity) * 100,
                            )}
                            %)
                          </span>
                        </div>
