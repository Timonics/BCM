...
import { Users, Music, Crown, UserCheck, GraduationCap, Calendar, TrendingUp, BarChart3, ClipboardCheck, ChartBar, Settings, Bell, AlertCircle, Clock } from "lucide-react";
          ...
          <CardContent className="p-4 md:p-6">
            <div className="space-y-4">
              <p className="text-sm md:text-base text-[#8F9BB3]">
                This dashboard provides you with an overview of your church's
                operations. Use the sidebar to navigate to different sections
                and manage your church efficiently.
              </p>
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 bg-blue-50 rounded-lg">
                  <p className="text-xs text-[#8F9BB3] mb-1">Active Today</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg border border-red-200 bg-red-50/50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[#8F9BB3] mb-2">
                  Michael Chen's tenure as Choir Band Leader expires in 7 days.
                  Please review and assign a successor.
                </p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-xs text-[#8F9BB3]">
                    <Clock className="w-3 h-3" />2 hours ago • Jan 31, 2026,
                    10:15 AM
                  </div>
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg border border-orange-200 bg-orange-50/50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-xs text-[#8F9BB3]">
                    <Clock className="w-3 h-3" />5 hours ago • Jan 31, 2026,
                    7:20 AM
                  </div>
                  <Button size="sm" variant="outline" className="h-7 text-xs">
                    View Profile
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg border border-green-200 bg-green-50/50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[#8F9BB3] mb-2">
                  12 members have successfully completed the Baptismal Class.
                  Certificates are ready for distribution.
                </p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-xs text-[#8F9BB3]">
                    <Clock className="w-3 h-3" />1 day ago • Jan 30, 2026, 2:00
                    PM
                  </div>
                  <Button size="sm" variant="outline" className="h-7 text-xs">
                    View Details
