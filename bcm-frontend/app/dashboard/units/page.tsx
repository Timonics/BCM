...
import AddNewUnitModal from "@/components/modal/add-unit";
import EditUnitModal from "@/components/modal/edit-unit";
...
export default function UnitsListScreen() {
  ...
  const onNavigateToUnitDetail = (unitId: string) => {
  ...
  const units: Unit[] = [
    ...
    },
    {
      ...
      description:
        "Handles audio/visual, live streaming, and digital content creation",
      leadershipAlerts: 0,
      status: "Active",
      trend: "up",
      lastUpdated: "2025-12-28",
  ...
  const totalLeadershipAlerts = units.reduce(
    (sum, unit) => sum + unit.leadershipAlerts,
    0,
  );
  ...
  const filteredUnits = units.filter((unit) => {
    ...
    const matchesCategory =
      filters.category === "all" || unit.category === filters.category;
    const matchesStatus =
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#8F9BB3] mt-1">
            Manage all church units and their operations
          </p>
        </div>
        <Button
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            >
              ...
              {(filters.category !== "all" ||
                ...
                <Badge
                  variant="outline"
                  className="ml-2 bg-[#009AF4] text-white border-[#009AF4]"
                >
                  Active
                </Badge>
              )}
            ...
            >
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-semibold text-[#222B45] truncate">
                        {unit.name}
                      </h3>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <Badge
                    variant="outline"
                    className={getCategoryBadgeColor(unit.category)}
                  >
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between text-xs text-[#8F9BB3]">
                    ...
                    <span>
                      {unit.membersCount - unit.activeMembers} inactive
                    </span>
                  </div>
                </div>
                ...
                {unit.leadershipAlerts > 0 ? (
                  <div className="flex items-start gap-2 p-2 rounded-lg border bg-orange-50 text-orange-700 border-orange-200">
                    <BellRing className="w-4 h-4 shrink-0 mt-0.5 animate-pulse" />
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-medium">
                        {unit.leadershipAlerts} leadership position
                        {unit.leadershipAlerts > 1 ? "s" : ""} need
                        {unit.leadershipAlerts === 1 ? "s" : ""} attention
                      </p>
                    </div>
                  </div>
                ) : (
                  <div className="flex items-center gap-2 p-2 rounded-lg border bg-green-50 text-green-700 border-green-200">
                    ...
                    <p className="text-xs font-medium">
                      All leadership positions current
                    </p>
                  </div>
                )}
                    ...
                    <td className="px-6 py-4">
                      {unit.leadershipAlerts > 0 ? (
                        ...
                        >
                          ...
                          {unit.leadershipAlerts} alert
                          {unit.leadershipAlerts > 1 ? "s" : ""}
                        </Badge>
                      ) : (
                        <Badge
                          variant="outline"
