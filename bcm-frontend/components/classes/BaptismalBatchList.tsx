...
export function BaptismalBatchList({
  onViewBatch,
}: BaptismalBatchListProps = {}) {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-700">
              Baptismal Class batches are automatically created by the system
              for January and August intake periods. Batches cannot be deleted
              but leadership and member assignments can be managed.
            </p>
          </div>
        </div>
      </div>
